              ...
              >
                ...
                >
                  <button
                    type="button"
                    onClick={closeModal}
                    className={`absolute z-10 p-2 top-2 right-2 rounded-full 
                  ...
                  <div className="flex flex-col flex-1 gap-3">
                    ...
                    <div className="flex gap-3">
                      ...
                      <div className="relative flex-1 w-full h-24 bg-primary-blue-100 ronded-lg">
                        <Image
                          src="/hero.png"
                          alt="car model1"
                          fill
